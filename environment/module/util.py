...
def rejection_placement(env, placement_fn, floor_size, obj_size, num_tries=1000000):
    '''
        Args:
    ...
    for i in range(num_tries):
        ...
        if pos[0]-obj_size_in_cells[0]//2 <= 0 or pos[0]+obj_size_in_cells[0]//2 >= 8080 or pos[1]-obj_size_in_cells[1]//2 <= 0 or pos[1]+obj_size_in_cells[1]//2 >= 4480:
            continue
        if np.any(grid[pos[0]-obj_size_in_cells[0]//2:pos[0]+obj_size_in_cells[0]//2, pos[1]-obj_size_in_cells[1]//2:pos[1]+obj_size_in_cells[1]//2]):
            continue
        else:
            ...
            grid[pos[0]-obj_size_in_cells[0]//2:pos[0]+obj_size_in_cells[0]//2, pos[1]-obj_size_in_cells[1]//2:pos[1]+obj_size_in_cells[1]//2] = 1
